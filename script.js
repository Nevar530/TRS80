...
function renderOverviewWeaponsMini(mech){
  ...
  function initSearchUI(){
    ...
    Object.assign(wrap.style, { position:'relative', display:'inline-block', minWidth:'160px', marginLeft:'6px' });

    const input = document.createElement('input');
    Object.assign(input, { type:'search', id:'mech-search', placeholder:'Search mechs…', autocomplete:'off', spellcheck:false });
    Object.assign(input.style, { padding:'6px 10px', borderRadius:'6px', border:'1px solid var(--border)', background:'#0e1522', color:'var(--ink)', width:'160px' });
